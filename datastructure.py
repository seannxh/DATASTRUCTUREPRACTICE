...
def slice_foods():
    ...
    #[:2] → Keeps everything before index 2 (excludes "Fries" and "Burger").
    # [2:] → Keeps everything starting from index 2 onward (excludes "Carrot" and "Steak").
    # [1:3] → Keeps elements from index 1 to 3  GETS BETWEEN THE INDEX ONLY 1 and 3 gets deleted(excludes "Carrot" and "Burger").
